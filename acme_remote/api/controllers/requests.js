...
*/
var initPath = process.env.HEROKU_PATH || process.argv[1];
privateKey = fs.readFileSync(initPath + '/../keys/private.pem', 'utf8');
publicKey = fs.readFileSync(initPath + '/../keys/public.pem', 'utf8');
                                ...
                                .then((request) => {
                                    ...
                                    Promise.all(voucherPromises).then(valuesVPromises => {
                                        ...
                                        Promise.all(linesPromises).then(() => {
                                            BlackList.findAll({
                                            ...
                                            }).then(function (lastBlacklisteds) {
                                                ...
                                                RequestResponse.lastBlacklisteds = lastBlacklisteds;
