...
//    String basePath = "https://cmov1.herokuapp.com/api";
     ...
     * @return Request
     */
    public Request createRequest(RequestParam request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     ...
     * @param request
     */
    public void createRequest(RequestParam request, final Response.Listener<Request> responseListener, final Response.ErrorListener errorListener) {
        Object postBody = request;
    ...
    public LinesVouchersResponse getRequestlines(Integer requestId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
        ...
        // create path and map variables
        String path = "/requestlines".replaceAll("\\{format\\}", "json");
