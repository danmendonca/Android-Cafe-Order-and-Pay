...
public class DefaultApi {
  ...
  * Adds a costumer to the blacklist
   ...
   * @return Blacklist
  */
  public Blacklist addToBlacklist (Blacklist blacklist) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param blacklist 
  */
  public void addToBlacklist (Blacklist blacklist, final Response.Listener<Blacklist> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = blacklist;
  ...
  * Login
   ...
   * @return Costumer
  */
  public Costumer logMe (Costumer costumer) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = costumer;
  
      // verify the required parameter 'costumer' is set
      if (costumer == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'costumer' when calling logMe",
      new ApiException(400, "Missing the required parameter 'costumer' when calling logMe"));
      }
   ...
   * @param costumer 
  */
  public void logMe (Costumer costumer, final Response.Listener<Costumer> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = costumer;
